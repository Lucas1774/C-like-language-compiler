...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Sep 08 12:54:24 CEST 2023
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	RESULT=sentencia;
		...
		Referencia r = new Referencia(a.getName() , "ACCESO_VECTOR");
	...
	Referencia r = new Referencia(mySymbol.getName(), "IDENTIFICADOR");
	RESULT = r;
	...
	if (reference.getType().equals("ACCESO_VECTOR")){;
		...
		cb.addQuadruple("STP", reference.getTemporal(), tempSuma); // index of var = tempSuma
	} else{
	...
	sentencia.setIntermediateCode(cb.create());
	semanticErrorManager.semanticDebug("Codigo intermedio asignacionSuma " + reference.getName() + "[" + reference.getTemporal() + "]" + " = " + e.getValue() +": " + sentencia.getIntermediateCode());
	RESULT = sentencia;
	...
	sentencia.setIntermediateCode(cb.create());
	semanticErrorManager.semanticDebug("Codigo intermedio asignacion " + reference.getName() + "[" + reference.getTemporal() + "]" + " = " + e.getValue() +": " + sentencia.getIntermediateCode());
	RESULT = sentencia;
	...
	AccesoVector accesoVector = new AccesoVector (id.getLexema());
