...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Aug 25 02:05:38 CEST 2023
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	RESULT = dv;
          ...
          case 17: // seccionVariables ::= declaracionVariable 
            {
              ArrayList<DeclaracionVariable> RESULT =null;
		...
		ArrayList<DeclaracionVariable> dvs = (ArrayList<DeclaracionVariable>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		...
		DeclaracionVariable dv = (DeclaracionVariable)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
	...
	scopeManager.getCurrentScope().getSymbolTable().addSymbol(newSymbol);
          ...
          case 9: // seccionConstantes ::= epsilon 
            {
              ArrayList<DeclaracionConstante> RESULT =null;
          ...
          case 6: // axiom1 ::= seccionVariables seccionFunciones 
            {
              Axiom1 RESULT =null;
		int listaDeclaracionesVariablesleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int listaDeclaracionesVariablesright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		ArrayList<DeclaracionVariable> listaDeclaracionesVariables = (ArrayList<DeclaracionVariable>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		...
		int listaDeclaracionesConstantesleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int listaDeclaracionesConstantesright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		ArrayList<DeclaracionConstante> listaDeclaracionesConstantes = (ArrayList<DeclaracionConstante>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		int listaDeclaracionesTiposleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int listaDeclaracionesTiposright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		ArrayList<DeclaracionTipo> listaDeclaracionesTipos = (ArrayList<DeclaracionTipo>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int aleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int aright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
