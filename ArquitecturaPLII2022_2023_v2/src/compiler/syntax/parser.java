...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Aug 28 02:48:28 CEST 2023
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	printQuadruplesList.add(new Quadruple("CADENA", new Label(e.getTemporal().toString()), label)); 
	...
	scopeManager.getCurrentScope().getTypeTable().addType(new TypeSimple(scopeManager.getCurrentScope(), "entero"));
		...
		semanticErrorManager.semanticDebug("Codigo intermedio axioma: " + ax.getIntermediateCode());
